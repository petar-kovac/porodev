    ...
    public class UserService : IUserService
    {
        ...
        private SendEmailRequest CreateVerificationEmailProperties(string EmailReceiver, Dictionary<string, string> OtherProperties)
        {
            var returnModel = new SendEmailRequest()
            {
                ...
                htmlTextContent = $"<h1>Verification email</h1><p>Please click on this link http://localhost:3000/verify/{EmailReceiver}/{OtherProperties["VerificationToken"]} to verify your account</p>"
            };
